<template>
    <div class="message-alert">
        <div class="alert alert-dismissible l-alert" :class="'alert-' + item.status" v-for="(item, i) in messages" :key="i">
            <div v-if="item.status === 'success'" class="d-flex align-items-cneter justify-content-between">
                <i class="far fa-check-circle fa-lg mr-2" style="line-height:1"></i>
                <span>{{ item.message }}</span>
            </div>
            <div v-else class="d-flex align-items-cneter justify-content-between">
            ...
            <button type="button" id="close" class="close" @click="removeMessage(i)">

      ...
      <div class="card rounded-0 h-100">
        ...
        <div class="card-body">
          <div class="d-flex flex-column flex-lg-row">
            <select class="custom-select mr-2 mb-3 mb-lg-0 l-select"
              v-model="chooseyear"
              @change="checkdate()">
              <option value="" disabled>請選擇年份</option>
              <option :value="year" v-for="year in selectYear" :key="year">{{year}}</option>
            </select>
            <select class="custom-select mr-2 mb-3 mb-lg-0 l-select" v-model="choosemonth"
              :disabled="!chooseyear || check"
              @change="checkdate()">
